      ...
      <div className="container mx-auto px-6 relative z-10">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 leading-relaxed">
                      ...
                      1/333, Chinnathottam, Thottipalayam,<br />
                      Somanur, Coimbatore, Tamil Nadu, India.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 hover:text-white transition-colors cursor-pointer">+91 95665 58420</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 hover:text-white transition-colors cursor-pointer">krishnapowertechnologies@gmail.com</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    type="email"
                    placeholder="krishnapowertechnologies@gmail.com"
                    className="w-full bg-black/20 border border-white/10 rounded-xl px-5 py-4 text-white placeholder-gray-600 focus:outline-none focus:border-orange-500/50 focus:bg-black/30 transition-all"
                  />
                </div>
        ...
        <div className="mt-32 pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-gray-500">© 2024. KRISHNA POWER TECHNOLOGIES LTD</p>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="https://www.instagram.com/krishna_solarr" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 hover:text-pink-400 transition-all">
              <Instagram size={18} />
            </a>
            <a href="https://www.linkedin.com/in/krishna-power-technologies-50b88838a" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 hover:text-blue-500 transition-all">
              <Linkedin size={18} />
            </a>
          </div>
        </div>
